...
Class User_List extends Controller {
    ...
    function __construct() {
        ...
        $this->load->model('admdata/User_List_Model');
    }
    ...
    function result($str_search='_', $start=0) {
		...
		$data['list'] = $this->User_List_Model->GetData($str_search, $start, $this->offset);
		$data['total'] = $this->User_List_Model->getCount();
		$data['start'] = $start;

		//print_r($data);
		$paging = array();
		$paging['base_url'] = base_url() . 'admdata/user_list/result/' . $str_search . '/';
...
//VIEW//
    function _view($data = array()) {
        $this->load->view('admdata/user_list', $data);
    }
}
