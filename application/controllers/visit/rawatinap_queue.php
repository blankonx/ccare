...
Class Rawatinap_Queue extends Controller {
    ...
    function __construct() {
        ...
        $this->load->model('visit/Rawatinap_Queue_Model');
        //$this->js[] = "jquery/js/jquery.jeditable.js";
        $this->title = "Pasien Dirawat";
    }
    
    function index() {
        $data = array();
        $data['combo_clinics'] = $this->Rawatinap_Queue_Model->GetComboClinics();
        $this->_view($data);
    }
    ...
    function process_form() {
        ...
        if($this->input->post('id')) {
			...
			if($this->Rawatinap_Queue_Model->DoUpdateData()) {
			...
			if($this->Rawatinap_Queue_Model->DoAddData()) {
    ...
    function delete_list() {
        ...
        if($this->Rawatinap_Queue_Model->DoDeleteData()) {
...
//VIEW//
    function _view($data = array()) {
        ...
        $this->load->view('visit/rawatinap_queue', $data);
