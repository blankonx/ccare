...
<div class="ui-dialog" style="width:100%;margin-right:5px;height:auto;float:left;">
	...
	<div class="ui-dialog-content" id="dialogContent">
		<form method="POST" name="frmReport" id="frmReport" action="<?php echo site_url('kasir/harian/process_form')?>">
		<table cellpadding="0" cellspacing="0" border="0" class="tblInput" style="width:100%">
			<tr>
				<td style="width: 150px;"><?php echo $this->lang->line('label_payment_type')?></td>
				<td>
					<select id="payment_type_id" name="payment_type_id" onkeypress="focusNext( 'unit', 'unit', this, event)" style="width:200px;background:#FFFFFF;">
						<option value="">--- <?php echo $this->lang->line('form_all');?> ---</option>
							<?php $k=0; for($i=0;$i<sizeof($combo_payment_type);$i++) :?>
