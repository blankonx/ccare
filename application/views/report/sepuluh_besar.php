...
<div class="ui-dialog" style="width:100%;margin-right:5px;height:auto;float:left;">
	...
	<div class="ui-dialog-content" id="dialogContent">
		<form method="POST" name="frmReport" id="frmReport" action="<?php echo site_url('report/sepuluh_besar/process_form')?>">
		<table cellpadding="0" cellspacing="0" border="0" class="tblInput" style="width:100%">
			<tr>
				<td style="width: 150px;">Kelompok Penyakit</td>
				<td style="width: 300px;">
					<select name="icd_group_id" id="icd_group_id" style="width: 200px;float:left;">
						<option value="">--- <?php echo $this->lang->line('form_all');?> ---</option>
                        <?php for($i=0;$i<sizeof($combo_kelompok_penyakit);$i++) :?>
                        <option value="<?php echo $combo_kelompok_penyakit[$i]['id']?>"><?php echo $combo_kelompok_penyakit[$i]['name']?></option>
                        <?php endfor;?>
                        </select>
                    <div class="help" title="Untuk menambah/merubah kelompok penyakit, masuk ke menu Manajemen Data -> Data Medis -> Kelompok Penyakit"></div>
			...
			<tr>
				<td>Tampilkan</td>
				<td>
					<select name="tampilkan" style="width:150px">
