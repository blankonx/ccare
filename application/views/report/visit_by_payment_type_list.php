...
function exportCallback(obj) {
	if(img2) {
		openPrintPopup('visit_by_payment_type/printout/<?php echo underscore($report_title);?>');
	} else {
		if(n < 5) {
...
<input type="button" value="Cetak" onclick="exportCharts('Visit_By_Payment_TypeChart', 'Visit_By_Payment_TypeChart_Total', 'JPG')" id="buttonExport" />
</div>
