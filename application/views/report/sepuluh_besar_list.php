...
function exportCallback(obj) {
	...
	openPrintPopup('sepuluh_besar/printout/<?php echo underscore($report_title);?>');
	//alert(lebar);
}
</script>
...
<input type="button" value="Cetak" onclick="exportCharts('Sepuluh_BesarChart', 'JPG')" id="buttonExport" />
</div>
