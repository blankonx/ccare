...
function exportCallback(obj) {
	...
	//openPrintPopup('patient_sex/pdf/' + basename(filename));
	openPrintPopup('patient_sex/printout/<?php echo underscore($report_title);?>');
	//alert(lebar);
}
</script>
...
<input type="button" value="Cetak" onclick="exportCharts('Kunjungan_Sex_PatientsChart', 'JPG')" id="buttonExport" />
</div>
