...
$(document).ready(function() {
    ...
    $('#ping_button').click(function() {
        ...
        $.get('<?php echo site_url("report/e-claim/lap_morbiditas/ping_server")?>', function(data) {
    ...
    $('#ping_button2').click(function() {
        ...
        $.get('<?php echo site_url("report/lap_jamkesmas/ping_server")?>', function(data) {
...
<div class="ui-dialog" style="width:100%;margin-right:5px;height:auto;float:left;">
	...
	<div class="ui-dialog-content" id="dialogContent">
		<form method="POST" name="frmReport" id="frmReport" action="<?php echo site_url('report/lap_jamkesmas/process_form')?>">
