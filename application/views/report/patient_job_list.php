...
function exportCallback(obj) {
	...
	//openPrintPopup('patient_job/pdf/' + basename(filename));
	openPrintPopup('patient_job/printout/<?php echo underscore($report_title);?>');
	//alert(lebar);
}
</script>
...
<table cellpadding="1" cellspacing="0" border="0" class="tblListData" style="width:700px;margin:10px auto">
    ...
    <tr>
        ...
        <th><?php echo $this->lang->line('label_job')?></th>
...
<input type="button" value="Cetak" onclick="exportCharts('Patient_JobChart', 'JPG')" id="buttonExport" />
</div>
