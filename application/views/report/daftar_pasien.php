...
//get List Data
	function getList() {
		$('#divSearchResult').load("<?php echo site_url('rekammedis/daftar_pasien_list/result/_');?>" + "/" + $('#current_page').val(),prepareList);return false;
	}
...
function get_data_by_id(idx) {
	$.ajax({
		type: "POST",
		dataType: "json",
		url: "daftar_pasien/get_data_by_id",
		data: "id="+idx,
...
<div class="smallSearchContainer" id="div_search" style="display:none;">
	...
	<form method="POST" name="frmSearch" id="frmSearch" action="<?php echo site_url('rekammedis/daftar_pasien_list');?>">
...
<div class="ui-dialog" style="width:100%;margin-right:5px;height:auto;float:left;">
	<div style="position: relative;" class="ui-dialog-container">
		<div class="ui-dialog-titlebar">Daftar Pasien Puskesmas</div>
		<div class="ui-dialog-content">
			...
			<form method="POST" name="frmList" id="frmList" action="<?php echo site_url('rekammedis/daftar_pasien/delete_list');?>">
