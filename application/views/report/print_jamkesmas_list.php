...
<input type="button" value="Cetak" onclick="openPrintPopup('print_jamkesmas/printout/');"/>
<input type="button" value="Export ke Excel" onclick="openPrintPopup('print_jamkesmas/excel/');"/>
</div>
