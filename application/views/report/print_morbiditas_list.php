...
<table cellpadding="1" cellspacing="0" border="0" class="tblListData" style="width:1000px;margin:10px auto">
    <thead>
		...
		<td><?php echo $thn['year'];?></td>
		<td><?php echo $thn['month'];?></td>
		<td><?php echo $thn['day'];?></td>
        <td><?php echo $list[$i]['sex'];?></td>
        <td><?php echo $list[$i]['kode_desa'];?></td>
        <td><?php echo $list[$i]['nama_desa'];?></td>
...
<input type="button" value="Cetak" onclick="openPrintPopup('print_morbiditas/printout/');"/>
<input type="button" value="Export ke Excel" onclick="openPrintPopup('print_morbiditas/excel/');"/>
</div>
