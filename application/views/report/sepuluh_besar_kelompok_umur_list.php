...
function exportCallback(obj) {
	...
	openPrintPopup('sepuluh_besar_kelompok_umur/printout/<?php echo underscore($report_title);?>');
	//alert(lebar);
}
</script>
...
<input type="button" value="Cetak" onclick="exportCharts('Sepuluh_Besar_Kelompok_UmurChart', 'JPG')" id="buttonExport" />
</div>
