...
<a class="link_history_list_all" href="rawatinap_pemeriksaan_lab/detail/<?php echo $list[$i]['id']?>">
    <div class="history_list_all">
        <div>
            <em>(<?php echo $list[$i]['datediff'];?>&nbsp;&nbsp;<span style="font-style:normal;font-size:8pt;font-weight:bold;"><?php echo $list[$i]['date'] ?></span>),
            <?php echo $list[$i]['jenis']?>
            </em>
        </div>
    </div>
</a>
