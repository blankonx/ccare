...
<div id="body">
    ...
    <div style="text-align:center;">No. <?php echo $detail['no']?></div><br/>Yang bertanda tangan dibawah ini Dokter UPT <?php echo $profile['name'] . ", " . removeKotaKab($profile['district']);?>, dengan ini menerangkan bahwa :<br/><br/>
    ...
    <table cellpadding="0" cellspacing="0" border="0" >
        <tr>
            <td style="width:150px;"><?php echo $this->lang->line('label_weight');?></td>
            <td style="width:150px;">:&nbsp;<?php echo $detail['weight'];?></td>
            <td style="width:150px;"><?php echo $this->lang->line('label_blood_pressure');?></td>
            <td style="width:150px;">:&nbsp;<?php echo $detail['sistole'] . "/" . $detail['diastole'];?> mmHg</td>
        </tr>
        <tr>
	...
	<br/>
	Pada saat pemeriksaan ini dalam keadaan <b><?php echo $detail['result'];?></b> dan surat keterangan ini dapat digunakan untuk : <b><?php echo $detail['explanation'];?></b>.<br/><br/>
    Demikian surat keterangan ini dibuat, dengan mengingat sumpah saat menerima jabatan, agar dapat dipergunakan sebagaimana mestinya.
    <div style="margin-top:2cm;"></div>
    <div style="float:left;width:9cm;text-align:center;visibility:hidden">
        Tanda tangan pemegang<br/>Surat keterangan<br/><br/><br/>
        <?php echo $detail['name'];?>
    </div>
    <div style="float:left;width:9cm;text-align:center;">
