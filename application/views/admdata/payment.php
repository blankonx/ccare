...
//get List Data
	function getList() {
		$('#divSearchResult').load("<?php echo site_url('admdata/payment_list/result/_');?>" + "/" + $('#current_page').val(),prepareList);return false;
	}
...
<div class="smallSearchContainer" id="div_search" style="display:none;">
	...
	<form method="POST" name="frmSearch" id="frmSearch" action="<?php echo site_url('admdata/payment_list');?>">
...
<div class="ui-dialog" style="width:100%;margin-right:5px;height:auto;float:left;">
	<div style="position: relative;" class="ui-dialog-container">
		<div class="ui-dialog-titlebar">Data Jenis Pasien</div>
		...
		<form method="POST" name="frmInput" id="frmInput" style="display:none" action="<?php echo site_url('admdata/payment/process_form')?>">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="tblInput">
			...
			<form method="POST" name="frmList" id="frmList" action="<?php echo site_url('admdata/payment/delete_list');?>">
