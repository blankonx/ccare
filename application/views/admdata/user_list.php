...
<table cellpadding="0" cellspacing="0" border="0" class="tblListData">
	...
	<?php else :?>
		...
		<tr class="notSelected">
			...
			<td ondblclick="get_data_by_id('<?php echo $list[$i]['id'];?>')" id="username_<?php echo $list[$i]['id'];?>"><?php echo $list[$i]['username'];?></td>
			<td ondblclick="get_data_by_id('<?php echo $list[$i]['id'];?>')" id="telp_rumah_<?php echo $list[$i]['id'];?>"><?php echo $list[$i]['group'];?></td>
			<td ondblclick="get_data_by_id('<?php echo $list[$i]['id'];?>')" id="telp_rumah_<?php echo $list[$i]['id'];?>"><?php echo $list[$i]['clinic'];?></td>
		</tr>
		<?php endfor;?>
	<?php endif;?>
	</tbody>
