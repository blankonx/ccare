...
<table cellpadding="0" cellspacing="0" border="0" class="tblListData">
	...
	<?php else :?>
		...
		<tr>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo (++$start);?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['mr_number'];?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['nik'];?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['name'];?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['sex'];?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['birth_date'];?></td>
			<td style="text-align:right" onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo getOneAge($list[$i]['birth_date'], $data[$i]['curdate']);?></td>
			<td onclick="get_patient_from_search('<?php echo $list[$i]['mr_number']?>')"><?php echo $list[$i]['address'];?></td>
			<td>
