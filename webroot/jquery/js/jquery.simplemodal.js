...
(function ($) {
	...
	$.modal.defaults = {
		...
		onClose: null,
		title:false,
		titleHTML:'<div class="modalTitle"></div>',
		titleClass:'simplemodal-title'
	};
	...
	$.modal.impl = {
		...
		create: function () {
			...
			this.dialog.container = $('<div/>')
				...
				.append(!this.opts.title 
					? ''
					: $(this.opts.titleHTML).addClass(this.opts.titleClass).text(this.opts.title))
