 ...
 */			  
@unlink("../webroot/media/charts/chart.jpg");
@unlink("../webroot/media/charts/chart2.jpg");
define ( "SAVE_PATH",  "../webroot/media/charts/" );
 ...
 */
define ( "HTTP_URI", "http://localhost/sikesda-puskesmas/webroot/media/charts/" );
